...
% y_new_data_GM(7) = -y_new_data_GM(7);

y_new_data_CSF(4) = -y_new_data_CSF(4);
y_new_data_CSF(6) = -y_new_data_CSF(6);
y_new_data_CSF(14) = -y_new_data_CSF(14);
...
hold off
% Add text boxes with intersection values
text(y_GM-50, 10, sprintf('GM: %.1f ms', y_GM),'FontSize',20);
text(y_WM-150, -10, sprintf('WM: %.1f ms', y_WM),'FontSize',20);
text(y_CSF-20, -10, sprintf('CSF: %.1f ms', y_CSF),'FontSize',20);
